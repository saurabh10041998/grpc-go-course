...
func (c *calculatorServiceClient) Add(ctx context.Context, in *CalculateRequest, opts ...grpc.CallOption) (*CalculateResponse, error) {
...
func (UnimplementedCalculatorServiceServer) Add(context.Context, *CalculateRequest) (*CalculateResponse, error) {
...
func _CalculatorService_Add_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CalculatorServiceServer).Add(ctx, req.(*CalculateRequest))
	}
