...
type SqrtRequest struct {
	...
	Number        int32                  `protobuf:"varint,1,opt,name=number,proto3" json:"number,omitempty"` // Could have been uint32
...
const file_sqrt_proto_rawDesc = "" +
	...
	"\x06result\x18\x01 \x01(\x01R\x06resultB<Z:github.com/saurabh10041998/grpc-go-course/calculator/protob\x06proto3"
